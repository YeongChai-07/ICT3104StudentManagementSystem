    ...
    <div class="col-md-12 col-sm-12">
        ...
        <table width="100%" cellpadding="5" cellspacing="5" id="recommendationsList" border="1"  class="table table-striped table-bordered dt-responsive" >
            <thead>
                ...
                <tr><th>S/N</th><th>Student Name</th><th>Recommendation</th><th>Recommended Marks</th><th width="40%">Action</th></tr>
            </thead>
            <tbody>
                ...
                <td>
                <a class="btn btn-info" href="{{  $recommendation->id }}/moderateGrade">Update Grades</a>
